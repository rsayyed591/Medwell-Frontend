          ...
          {appointments.length === 0 ? (
            ...
            <ul className="space-y-4">
              {appointments.map((appointment) => {
                ...
                return (
                  <li key={appointment.id} className="bg-gray-50 p-3 lg:p-4 rounded-md flex justify-between items-start">
                    <div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <p><strong>Start:</strong> {moment(selectedAppointment.start).format('MMMM D, YYYY h:mm A')}</p>
                <p><strong>End:</strong> {moment(selectedAppointment.end).format('MMMM D, YYYY h:mm A')}</p>
